...
JSMSetting<AdaptiveTriggerSetting> left_trigger_effect = JSMSetting<AdaptiveTriggerSetting>(SettingID::ADAPTIVE_TRIGGER, AdaptiveTriggerSetting() );
JSMSetting<AdaptiveTriggerSetting> right_trigger_effect = JSMSetting<AdaptiveTriggerSetting>(SettingID::ADAPTIVE_TRIGGER, AdaptiveTriggerSetting() );
...
int main(int argc, char *argv[])
{
	...
	commandRegistry.Add((new JSMAssignment<AdaptiveTriggerSetting>(adaptive_trigger))
	                      ->SetHelp("TODO: UPDATE"));
